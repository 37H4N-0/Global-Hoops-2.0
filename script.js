const shoeDatabase = [
  { id: 1, brand: "NIKE", name: "Kobe 5 Protro 'Eggplant'", releaseDate: "March 28, 2026 10:00:00", price: 200, hype: 5, img: "https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/e4e04410-d9d1-4475-bed0-6e4a2c918e6c/kobe-5-protro-basketball-shoe-9J0v9T.png", tech: "Zoom Turbo", desc: "A legendary return of the Mamba classic." },
  { id: 2, brand: "ADIDAS", name: "AE1 Velocity Blue", releaseDate: "April 05, 2026 10:00:00", price: 120, hype: 4, img: "https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/7f6517a618e04099a43e49e061c27df6_9366/AE_1_Velocity_Blue_Shoes_Blue_IF1864_01_standard.jpg", tech: "Jet Boost", desc: "The future of Adidas basketball." },
  { id: 3, brand: "JORDAN", name: "Luka 3 'Midnight'", releaseDate: "March 20, 2026 10:00:00", price: 130, hype: 3, img: "https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/609426f3-8f0c-4e5a-8b38-d7a8d9a4242d/luka-2-basketball-shoes-v4V9L6.png", tech: "IsoPlate", desc: "Crafted for precision step-backs." },
  { id: 4, brand: "NEW BALANCE", name: "Kawhi 4 'Pinkman'", releaseDate: "April 12, 2026 10:00:00", price: 165, hype: 3, img: "https://nb.scene7.com/is/image/NB/bbklsp1_nb_02_i?$pdp_main_v4_lg$&wid=700&hei=700", tech: "Energy Arc", desc: "Calculated performance for the two-way star." },
  { id: 5, brand: "UNDER ARMOUR", name: "Curry 12 'Flow'", releaseDate: "April 15, 2026 10:00:00", price: 160, hype: 4, img: "https://underarmour.scene7.com/is/image/UnderArmour/3026620-100_DEFAULT?wid=566&hei=708", tech: "UA Flow", desc: "Grip like no other." },
  { id: 6, brand: "ANTA", name: "Kai 1 'Enlightened'", releaseDate: "March 18, 2026 10:00:00", price: 125, hype: 5, img: "https://images.complex.com/complex/images/c_fill,f_auto,g_center,w_1200/fl_lossy,pg_1/v9qjvz6j8f5m7k4n5o9d/anta-kai-1-artist-on-court", tech: "NitroEdge", desc: "Kyrie's artistic expression on the court." }
];
...
function openModal(shoe) {
  ...
  document.getElementById('modal-body').innerHTML = `
    ...
    <div class="modal-info">
      ...
      <h2>${shoe.name}</h2>
      <p style="text-transform:none; line-height:1.6; color:#555;">${shoe.desc}</p>
      <p><strong>RETAIL:</strong> $${shoe.price} | <strong>TECH:</strong> ${shoe.tech}</p>
      ${actionBtn}
    </div>`;
